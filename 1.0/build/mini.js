...
gallery/rightClick/1.0/index
gallery/rightClick/1.0/mini
 ...
 * @module rightClick
 **/
KISSY.add('gallery/rightClick/1.0/index',function(S, Node, Base, Event, Juicer) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     *
    ...
    requires: ['node', 'base', 'event', 'gallery/juicer/1.3/index']
});
 ...
 * @module rightClick
 **/
KISSY.add('gallery/rightClick/1.0/mini',function(S, Component) {
